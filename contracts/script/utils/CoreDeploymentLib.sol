...
library CoreDeploymentParsingLib {
    ...
    function readDeploymentConfigValues(
        ...
        data.delegationManager.initialOwner = json.readAddress(
            ".delegationManager.initialOwner"
        );
        ...
        data.allocationManager.initialOwner = json.readAddress(
            ".allocationManager.initialOwner"
        );
